package md5b4a7341681c30e686ab89fa811d003bf;


public class CompassImplementation
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Compass.CompassImplementation, Plugin.Compass", CompassImplementation.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == CompassImplementation.class)
			mono.android.TypeManager.Activate ("Plugin.Compass.CompassImplementation, Plugin.Compass", "", this, new java.lang.Object[] {  });
	}
